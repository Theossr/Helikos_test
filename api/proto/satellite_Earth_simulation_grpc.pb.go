...
// UnimplementedSatelliteEarthSimulationServiceServer must be embedded to have
...
func (UnimplementedSatelliteEarthSimulationServiceServer) testEmbeddedByValue() {}
...
func RegisterSatelliteEarthSimulationServiceServer(s grpc.ServiceRegistrar, srv SatelliteEarthSimulationServiceServer) {
	// If the following call pancis, it indicates UnimplementedSatelliteEarthSimulationServiceServer was
